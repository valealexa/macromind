...
Con icone PWA/Home screen personalizzate (Fitness) e Salvataggio Dati Persistente.
"""
...
# ============================================================
# 0. CONFIGURAZIONE PAGINA E ICONA HOME SCREEN (PWA)
# ============================================================
st.set_page_config(
    page_title="MacroMind",
    page_icon="🏋️‍♂️", # Icona scheda browser e fallback PWA
    layout="wide",
    initial_sidebar_state="collapsed",
)

# Iniezione meta-tag per forzare il nome "MacroMind" e l'icona fitness quando si salva in Schermata Home
st.markdown("""
    <head>
        ...
        <!-- Link icona Fitness ad alta risoluzione per schermata Home -->
...
with st.form("form_piano"):
    ...
    submitted = st.form_submit_button("🚀 GENERA E SALVA SU DISCO", use_container_width=True)
...
if submitted:
    ...
    st.success("✅ Piano generato! I tuoi dati sono ora salvati e rimarranno memorizzati anche riaprendo l'app.")
